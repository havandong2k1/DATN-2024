                        ...
                        <div class="row justify-content-center mb-4">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <?php if (session()->has('msg_success')): ?>
                                    <div id="success" class="alert alert-success p-1" role="alert">
                                ...
                                <form class="mx-1 mx-md-4 mt-4" action="<?= base_url('views/register') ?>" method="post">
                                ...
                                <hr>
                                <div>
                                    <label class="text-center mt-4">Đã có tài khoản:</label> 
