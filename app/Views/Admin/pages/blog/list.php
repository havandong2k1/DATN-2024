                    ...
                    <?php if (isset($blogs) && !empty($blogs)) : ?>
                        <?php foreach ($blogs as $index => $blog) : ?>
                            <tr>
                                ...
                                <td class="text-center"><?= htmlspecialchars($blog['title']) ?></td>
                                <td class="text-center"><?= htmlspecialchars(substr($blog['content'], 0, 100)) . (strlen($blog['content']) > 100 ? '...' : '') ?></td>
                                ...
                                <td class="text-center"><?= date('d-m-Y H:i:s', strtotime($blog['created_at'])) ?></td>
                                <td class="text-center">
                                    <?php if ($blog['status_blogs'] == 1): ?>
